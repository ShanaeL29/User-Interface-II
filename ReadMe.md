...
- [inProgress]  Information about you in place of the given placeholder
- [check]  A `My Projects` button that links to the projects page
- [check]  A `Contact Me` button that links to the contact page
- [check]  Links to any social media profiles (Instagram, linkedIn, Twitter) into the footer section of your home page

### Task 3: Stretch Goals

The following goals are designed to stretch your knowledge and may require additional research beyond what was learned in class today.

- [check] Make your webpage work at different browser widths, including mobile
- [check] Add CSS animations
